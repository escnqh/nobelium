 ...
 * @LastEditTime: 2023-01-11 11:38:19
...
const NavBar = () => {
  ...
  const links = [
    ...
    { id: 4, name: locale.NAV.RSS, to: '/memos', show: true}
  ]
  return (
      ...
      >
        <div className="flex items-center">
          <Link href="/">
            ...
            <div className="text-black dark:text-gray-50 site-title">Peelson&acute;s blog</div>
            </a>
          </Link>
          {navBarTitle
            ? (
